...
export class ParticipantsController {
  ...
  @ApiOperation({
    summary: 'Vincular/desvincular um participante como dependente',
  })
  setSponsor(
    @CurrentUser() user: { id: string },
    @Param('tripId') tripId: string,
    ...
    return this.participantsService.setSponsor(
      user.id,
      tripId,
      participantId,
      dto.sponsorId,
...
export class JoinController {
  ...
  join(@CurrentUser() user: { id: string }, @Param('token') token: string) {
